...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32610',
            //extent: [667294.822058, 5465881.360203, 1449299.803410, 6722801.894939],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([428753.618933, 5651536.932036, 1743480.595420, 6225452.723586], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_FishStockingLocations2024_2,
    colName: 'WATERBODY',
    zoom: 10,
    collapsed: true,
    map: map
